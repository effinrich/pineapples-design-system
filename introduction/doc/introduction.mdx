...
<br />
<br />
Origami is a [React-Native](https://reactnative.dev) Design System starter kit, using
[Paper](https://reactnativepaper.com) component library: an open source components
library based on [Material Design](https://material.io/design).
